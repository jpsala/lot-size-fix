...
#define SMA_2 1     //iMA(NULL,0, SMAPeriod2, 0, MODE_SMA, PRICE_OPEN)
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 13)
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 8)
#define HEIKENASHI_1 4     //iCustom(NULL,0, "SqHeikenAshi")
...
string sqStrategyName = "Strategy 4.42.100";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsGreaterCount("sqGetIndicatorValue(SMA_1, 0, 1)","sqGetBid(\"Current\")",216,true,1));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(SMA_2, 0, 1), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMA_2] = iMA(NULL,0, SMAPeriod2, 0, MODE_SMA, PRICE_OPEN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 13);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 8);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(SMA_1, 0, 1)") {
          return sqGetIndicatorValue(SMA_1, 0, shift + 1);
      }
      if(id == "sqGetBid(\"Current\")") {
          return   sqGetBid("Current");
      }
...
bool sqSRPercRankAboveLevelXBars(int mode,int lenght,int ATRPeriod,double Level, int bars,int shift) {
	...
	bool atLeastOnce = false;
	int SRPCIndyHandle = iCustom(NULL,0, "SqSRPercentRank", mode,lenght ,ATRPeriod);
