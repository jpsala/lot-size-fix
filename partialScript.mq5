//+------------------------------------------------------------------+
//| Strategy 4.5.107(1) EA
//|
//|    Generated by StrategyQuant X Build 136 for MetaTrader5 (hedged)
//|    Generated at 07/23/2025 14:31
//| 
//|    Backtested on ndx_tick / H1, 2019.01.02 - 2025.07.08 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_4_5_107_1";
...
input int Period1 = 49;        //Period1
input double ProfitTargetCoef1 = 5.81;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.44;        //StopLossCoef1
input double TrailingStopCoef1 = 1.02;        //TrailingStopCoef1
input int BollingerBandsPrd1 = 52;        //BollingerBandsPrd1
...
input double MainChartTickSizeSQ = -1.0;
...
#define PARABOLICSAR_1 0     //iCustom(NULL,0, "SqParabolicSAR", 0.04, 0.2)
#define HIGHEST_1 1     //iCustom(NULL,0, "SqHighest", Period1, PRICE_TYPICAL)
#define BOLLINGERBANDS_1 2     //iBands(NULL,0, BollingerBandsPrd1, 0, 2.1, PRICE_CLOSE)
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 8)
#define ATR_2 4     //iCustom(NULL, 0, "SqATR", 3)
#define ATR_3 5     //iCustom(NULL, 0, "SqATR", 30)
#define HEIKENASHI_1 6     //iCustom(NULL,0, "SqHeikenAshi")
...
string sqStrategyName = "Strategy 4.5.107(1)";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(PARABOLICSAR_1, 0, 1), 6) <= NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(BOLLINGERBANDS_1, 0 + 1, 1), "Current");
      ...
      size = sqMMFixedAmount("Current",ORDER_TYPE_BUY_STOP,openPrice,sl,mmRiskedMoney,mmDecimals,mmLotsIfNoMM,mmMaxLots,mmMultiplier);
...
bool initIndicators(){
   ...
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.04, 0.2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", Period1, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BollingerBandsPrd1, 0, 2.1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 8);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 3);
